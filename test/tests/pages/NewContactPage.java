...
public class NewContactPage extends FluentPage {
   ...
   * @param telephoneType The form telephone data.
   */
  public void submitForm(String firstName, String lastName, String telephone, String telephoneType) {
    ...
    // Select a telephone type field.
    find("select", withId("telephoneType")).find("option", withId("Work")).click();
